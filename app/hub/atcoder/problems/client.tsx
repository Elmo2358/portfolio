...
interface AtCoderProblemsClientProps {
  initialProblems: any[]
}

export function AtCoderProblemsClient({ initialProblems }: AtCoderProblemsClientProps) {
  ...
  useEffect(() => {
    if (page > 1) fetchProblemsInternal()
  }, [page])
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <Tabs defaultValue="edit" className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="hints">AIヒント</TabsTrigger>
